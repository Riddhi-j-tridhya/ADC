...
add_action('wp_dashboard_setup', 'tt_widget_support_dashboard');

function tt_widget_support_dashboard() {
    global $wp_meta_boxes;

    wp_add_dashboard_widget('custom_help_widget', 'ABC Bank', 'tt_widget_support');
}
...
function tt_widget_support() {
    ?>
    
    <h3 style="font-weight: 700;">Business Inquiry</h3>
    <p>
        <strong>Tel:</strong> <a href=""></a><br />
        <strong>Email:</strong> <a href=""></a>
    </p>
    <h3 style="font-weight: 700;">Technical Support</h3>
    <p>
        <strong>Tel:</strong> <a href=""></a><br />
        <strong>Email:</strong> <a href=""></a>
    </p>
